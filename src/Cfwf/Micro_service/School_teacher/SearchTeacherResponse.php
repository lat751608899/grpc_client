...
/**
 * Generated from protobuf message <code>cfwf.micro_service.school_teacher.SearchTeacherResponse</code>
 */
class SearchTeacherResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *当前页结果列表
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.school_teacher.TeacherInfo list = 6;</code>
     */
    private $list;
