 ...
 *
 * Generated from protobuf message <code>cfwf.micro_service.account.GetUserBaseInfoRequest</code>
 */
class GetUserBaseInfoRequest extends \Google\Protobuf\Internal\Message
{
    /**
