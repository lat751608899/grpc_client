...
/**
 * Generated from protobuf message <code>cfwf.micro_service.account.SearchUserBaseInfoResponse</code>
 */
class SearchUserBaseInfoResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *当前页结果列表
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.account.UserBaseInfo list = 6;</code>
     */
    private $list;
     ...
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.account.UserBaseInfo list = 6;</code>
     * @param \Cfwf\Micro_service\Account\UserBaseInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cfwf\Micro_service\Account\UserBaseInfo::class);
        $this->list = $arr;
