...
/**
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetWebStatTeachersTheoryResponse</code>
 */
class GetWebStatTeachersTheoryResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *第一条表示“本市”的统计总数
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.resource_statistics.WebStatTheoryItem list = 6;</code>
     */
    private $list;
     ...
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.resource_statistics.WebStatTheoryItem list = 6;</code>
     * @param \Cfwf\Micro_service\Resource_statistics\WebStatTheoryItem[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cfwf\Micro_service\Resource_statistics\WebStatTheoryItem::class);
        $this->list = $arr;
