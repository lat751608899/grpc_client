...
/**
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetSchoolUserListResponse</code>
 */
class GetSchoolUserListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *当前页结果列表
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.resource_statistics.UserInfoSimple list = 6;</code>
     */
    private $list;
     ...
     *
     * Generated from protobuf field <code>repeated .cfwf.micro_service.resource_statistics.UserInfoSimple list = 6;</code>
     * @param \Cfwf\Micro_service\Resource_statistics\UserInfoSimple[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cfwf\Micro_service\Resource_statistics\UserInfoSimple::class);
        $this->list = $arr;
