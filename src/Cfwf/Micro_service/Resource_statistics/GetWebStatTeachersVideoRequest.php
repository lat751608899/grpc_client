 ...
 *
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetWebStatTeachersVideoRequest</code>
 */
class GetWebStatTeachersVideoRequest extends \Google\Protobuf\Internal\Message
{
    /**
     *学校id，不能为0
     *
