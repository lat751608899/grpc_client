...
/**
 *传入区县id，获取统计数据 "所有"， 返回 学校列表
 *
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetWebStatSchoolsAllRequest</code>
 */
class GetWebStatSchoolsAllRequest extends \Google\Protobuf\Internal\Message
{
    /**
     *所属区县教育局编号，必填
     *
