...
/**
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetNewSchoolWeikeStatisticsResponse</code>
 */
class GetNewSchoolWeikeStatisticsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cfwf\Micro_service\Resource_statistics\NewSchoolWeikeItem::class);
        $this->list = $arr;
