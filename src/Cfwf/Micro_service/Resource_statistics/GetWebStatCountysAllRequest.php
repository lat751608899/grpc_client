...
/**
 *传入市id，获取统计数据 "所有"， 返回 区县列表
 *
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetWebStatCountysAllRequest</code>
 */
class GetWebStatCountysAllRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * 地级市id，不能为0
     *
    ...
    private $subject = 0;
    /**
     *排名规则  1=theory_count 2=resource_count 3=video_count ... 按WebStatAllItem 中统计项顺序，从1开始
     *
