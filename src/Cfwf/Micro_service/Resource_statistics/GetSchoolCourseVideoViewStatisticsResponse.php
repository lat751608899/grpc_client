...
/**
 * Generated from protobuf message <code>cfwf.micro_service.resource_statistics.GetSchoolCourseVideoViewStatisticsResponse</code>
 */
class GetSchoolCourseVideoViewStatisticsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cfwf\Micro_service\Resource_statistics\SchoolCourseVideoViewItem::class);
        $this->list = $arr;
