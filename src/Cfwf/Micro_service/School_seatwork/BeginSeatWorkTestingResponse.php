...
/**
 * Generated from protobuf message <code>cfwf.micro_service.school_seatwork.BeginSeatWorkTestingResponse</code>
 */
class BeginSeatWorkTestingResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.cfwf.micro_service.school_seatwork.BeginSeatWorkTestingResponse.CMD_RESULT result = 1;</code>
     */
    private $result = 0;
    /**
    ...
    /**
     *如果返回kCmdResultSuccess/kCmdResultHasFinished/kCmdResultHasTimeout，保存我的剩余答题时间、得分等
     *
    ...
    {
        GPBUtil::checkEnum($var, \Cfwf\Micro_service\School_seatwork\BeginSeatWorkTestingResponse_CMD_RESULT::class);
        $this->result = $var;
