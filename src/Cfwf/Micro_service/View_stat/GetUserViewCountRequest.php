...
/**
 * Generated from protobuf message <code>cfwf.micro_service.view_stat.GetUserViewCountRequest</code>
 */
class GetUserViewCountRequest extends \Google\Protobuf\Internal\Message
{
    /**
     *所观看的资源的ID
     *
